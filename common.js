...
var Render = {
  ...
  sprite: function(ctx, width, height, resolution, roadWidth, sprites, sprite, scale, destX, destY, offsetX, offsetY, clipY) {
    ...
    // A sprite can have a high-resolution source rectangle while keeping
    // the game's original logical size. This lets detailed player artwork
    // stay sharp without changing collision/road scaling.
    var sourceW = sprite.sourceW || sprite.w;
    var sourceH = sprite.sourceH || sprite.h;
    ...
    if (clipH < destH)
      ctx.drawImage(
        sprites,
        sprite.x, sprite.y,
        sourceW, sourceH - (sourceH*clipH/destH),
        destX, destY,
        destW, destH - clipH
      );
...
SPRITES.CARS       = [SPRITES.CAR_QUICO, SPRITES.CAR_NHONHO, SPRITES.CAR_SEU_MADRUGA, SPRITES.CAR_DONA_FLORINDA, SPRITES.CAR_POPIS, SPRITES.CAR_PATI, SPRITES.CAR_PROFESSOR_GIRAFALES, SPRITES.CAR_DONA_CLOTILDE, SPRITES.CAR_GODINES];
// Vila do Chaves scenery sprites appended to the existing sheet.
...
SPRITES.VILA_BILLBOARDS = [SPRITES.VILA_CASA_14, SPRITES.VILA_CASA_71, SPRITES.VILA_CASA_72, SPRITES.VILA_CHURROS, SPRITES.VILA_PLACA_VILA, SPRITES.VILA_PLACA_SE_RENTA];
SPRITES.VILA_PLANTS = [SPRITES.VILA_ARVORE, SPRITES.VILA_ARVORE_FLORES, SPRITES.VILA_BARRIL, SPRITES.VILA_POSTE];
SPRITES.BILLBOARDS = SPRITES.VILA_BILLBOARDS;
SPRITES.PLANTS = SPRITES.VILA_PLANTS;
